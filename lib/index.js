    ...
    function Kinopio(serviceName, config) {
        ...
        this.rpcEventHandler = function (sourceService, eventType, handlerType, reliableDelivery, requeueOnError) {
            ...
            return function (target, propertyKey, descriptor) {
                ...
                _this.createEventHandler(sourceService, eventType, handlerType, propertyKey, originalFunction.bind(target), reliableDelivery, requeueOnError);
            };
        };
        this.createEventHandler = function (sourceService, eventType, handlerType, handlerName, handlerFunction, reliableDelivery, requeueOnError) { return __awaiter(_this, void 0, void 0, function () {
            var exclusive, serviceName, queueName, handlerNameString, exchangeName, autoDelete, eventChannel, eventExchange, eventQueue;
            var _this = this;
        ...
        this.userCallbackOnConnect = onConnect || (function () { return; });
