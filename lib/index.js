    ...
    function Kinopio(serviceName, config) {
        ...
        this.rpcEventHandler = function (sourceService, eventType, handlerType, reliableDelivery, requeueOnError) {
            ...
            return function (_, propertyKey, descriptor) {
                ...
                descriptor.value = _this.createEventHandler(sourceService, eventType, handlerType, propertyKey, originalFunction, reliableDelivery, requeueOnError);
            };
        };
        this.createEventHandler = function (sourceService, eventType, handlerType, handlerName, handlerFunction, reliableDelivery, requeueOnError) { return __awaiter(_this, void 0, void 0, function () {
            var exclusive, serviceName, queueName, exchangeName, autoDelete, eventChannel, eventExchange, eventQueue;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, eventChannel.assertExchange(exchangeName, 'topic', {
                                durable: true,
                                autoDelete: true
                            })];
                    case 2:
                    ...
                    case 3:
                        eventQueue = _a.sent();
                        return [4 /*yield*/, this.channel.bindQueue(eventQueue.queue, eventExchange.exchange, eventType)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.channel.consume(eventQueue.queue, function (message) {
